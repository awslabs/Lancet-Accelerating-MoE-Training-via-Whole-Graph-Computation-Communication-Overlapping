...
class FrameworkModel(BaseModel):
    ...
    def __init__(self, train_mod, infer_mod, arg_params, aux_params, param_attrs={}):
        ...
        self.__param_attrs = param_attrs
    ...
    def __add__(self, other):
        ...
        return FrameworkModel(new_mod, new_mod, self.__arg_params, self.__aux_params, self.__param_attrs)
    ...
    def _internal(self, *args, **kwargs):
        ...
        func = mod['main']
        if "is_expert_parallel" in self.__param_attrs:
            expert_params_map = self.__param_attrs["is_expert_parallel"]
            is_expert_parallel = []

            for var_node in func.params:
                var_name = var_node.name_hint
                if var_name in expert_params_map:
                    is_expert_parallel.append(expert_params_map[var_name])
                else:
                    is_expert_parallel.append(False)
        else:
            is_expert_parallel = [False] * len(func.params)
        named_params = {}
        ...
        return _TraceRecord(
            ...
            param_attributes={"is_expert_parallel": is_expert_parallel, "expert_params_map": expert_params_map}
        )
