...
register_op_cast_rule("raf.op.moe_encode", generic_cast(True, 2))
...
register_op_cast_rule("raf.op.moe_decode", infer_cast(2))
register_op_cast_rule("raf.op.moe_encode_dx", infer_cast(1))
register_op_cast_rule("raf.op.moe_encode_dg", infer_cast(1))
register_op_cast_rule("raf.op.moe_decode_dx", infer_cast(2))
register_op_cast_rule("raf.op.moe_decode_dg", infer_cast(2))
...
def op_cast_tuple_args(args, ret_type, amp_dtype):
    """For op that generates a tuple output whose behavior is quite simple, so it is safe
...
register_op_cast_rule("raf.op.split", op_cast_tuple_args)
register_op_cast_rule("raf.op._all_to_all", op_cast_tuple_args)
register_op_cast_rule("raf.op._all_to_allv", op_cast_tuple_args)
register_op_cast_rule("raf.op._allreduce", op_cast_tuple_args)
register_op_cast_rule("raf.op._allgather", infer_cast(1))
register_op_cast_rule("raf.op._reduce_scatter", infer_cast(1))