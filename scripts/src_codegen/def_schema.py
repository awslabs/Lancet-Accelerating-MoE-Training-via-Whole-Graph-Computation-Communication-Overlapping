...
SCHEMAS = {
    ...
    "moe.h::moe_encode": [
        Arg(name="data", cxx_type="value::BaseTensorValue"),
        Arg(name="gate", cxx_type="value::BaseTensorValue"),
        Arg(name="used_capacity", cxx_type="value::BaseTensorValue"),
        Arg(name="capacity_factor", cxx_type="float", cxx_default=1.0, py_default=1.0),
    ],
    "moe.h::moe_encode_batch_prioritized": [
        Arg(name="data", cxx_type="value::BaseTensorValue"),
        Arg(name="gate", cxx_type="value::BaseTensorValue"),
        Arg(name="n_partitions", cxx_type="int64_t", cxx_default=1, py_default=1),
        Arg(name="partition_id", cxx_type="int64_t", cxx_default=0, py_default=0),
        Arg(name="capacity_factor", cxx_type="float", cxx_default=1.0, py_default=1.0),
    ],
    "moe.h::moe_merge_masks": [
        Arg(name="indices_locations",
            cxx_type="std::vector<value::BaseTensorValue>",
            cxx_normalizer="TensorTuple",
        ),
        Arg(name="n_experts", cxx_type="int"),
    ],
    "moe.h::moe_redispatch": [
        Arg(name="data",
            cxx_type="std::vector<value::BaseTensorValue>",
            cxx_normalizer="TensorTuple",
        ),
    ...
    "moe.h::moe_redispatch_expert_input": [
        Arg(name="data",
            cxx_type="std::vector<value::BaseTensorValue>",
            cxx_normalizer="TensorTuple",
        ),
        ...
        Arg(name="local_expert_id", cxx_type="int"),
        Arg(name="n_local_experts", cxx_type="int"),
        Arg(name="recv_cnts_scale", cxx_type="int", cxx_default=1, py_default=1),
    ],
    "moe.h::moe_encode_dx": [
        Arg(name="dy", cxx_type="value::BaseTensorValue"),
        Arg(name="indices_locations", cxx_type="value::BaseTensorValue"),
    ],
    "moe.h::moe_encode_dg": [
        Arg(name="dy", cxx_type="value::BaseTensorValue"),
        Arg(name="indices_locations", cxx_type="value::BaseTensorValue"),
    ...
    "moe.h::moe_decode_dx": [
        ...
        Arg(name="indices_locations", cxx_type="value::BaseTensorValue"),
        Arg(name="n_experts", cxx_type="int"),
        Arg(name="capacity", cxx_type="int"),
    ],
    "moe.h::moe_decode_dg": [
        Arg(name="dy", cxx_type="value::BaseTensorValue"),
        Arg(name="data", cxx_type="value::BaseTensorValue"),
    ...
    "moe.h::sparse_expert_matmul_nt": [
        Arg(name="data", cxx_type="value::BaseTensorValue"),
        Arg(name="weight", cxx_type="value::BaseTensorValue"),
        Arg(name="nelements_per_gpu", cxx_type="value::BaseTensorValue"),
        Arg(name="nelements_offset", cxx_type="int"),
        Arg(name="nelements_stride", cxx_type="int", cxx_default=1, py_default=1),
        Arg(name="nelements_scale", cxx_type="int", cxx_default=1, py_default=1)
    ],
    "optimizer.h::sgd": [
        Arg(name="x", cxx_type="value::BaseTensorValue"),
    ...
    "communication.h::all_to_allv": [
        Arg(name="x", cxx_type="std::vector<value::BaseTensorValue>", cxx_normalizer="TensorTuple"),
        Arg(name="send_counts", cxx_type="std::vector<value::BaseTensorValue>", cxx_normalizer="TensorTuple"),
    ],
    ...
    "memory.h::copy_inplace": [
        Arg(name="dst_data", cxx_type="value::BaseTensorValue"),
        Arg(name="src_data", cxx_type="value::BaseTensorValue"),
        Arg(name="size", cxx_type="int64_t", cxx_default=-1, py_default=-1),
        Arg(name="dst_offset", cxx_type="int64_t", cxx_default=0, py_default=0),
        Arg(name="src_offset", cxx_type="int64_t", cxx_default=0, py_default=0),
    ],
    ...
    "memory.h::defuse_tensor": [
        Arg(name="data",
            cxx_type="value::BaseTensorValue"),
        Arg(name="sizes",
            cxx_type="std::vector<int64_t>",
            cxx_normalizer="IntTuple"),
        Arg(name="shapes",
