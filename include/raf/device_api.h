...
using StreamCallback = void(*)(void*);
...
class DeviceAPI {
 public:
  ...
  // Get the device for memory allocation. This API is for GPU only,
   ...
   */
  virtual void* CreateStream(const Device& dev, bool high_priority=false) = 0;
