...
/*!
 * \brief Get possible dispatched name for a call..
 * \param call The call values.
 * \return The possible dispatched openv names.
 */
 ...
 */
CallValues CreateDummyCallValues(Call call, Device device, bool include_args=true);
