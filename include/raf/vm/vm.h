...
class VMContextObj : public ValueObj {
 public:
  ...
  std::unordered_set<TensorValue, ObjectPtrHash, ObjectPtrEqual> shared_inputs;
...
class VirtualMachine : public tvm::runtime::ModuleNode {
 ...
 protected:
  ...
  /*! \brief Handle ForceFree instruction*/
  virtual void HandleForceFree(VMContext& ctx, const Instruction& instr);
