...
class MetaCache {
  ...
  using const_iterator = typename std::unordered_map<std::string, T>::const_iterator;
 public:
  ~MetaCache() = default;
  ...
  iterator begin() { return cached_.begin(); }
  iterator end() { return cached_.end(); }
  const_iterator begin() const { return cached_.begin(); }
  const_iterator end() const { return cached_.end(); }
  const_iterator cbegin() const { return cached_.cbegin(); }
  const_iterator cend() const { return cached_.cend(); }
